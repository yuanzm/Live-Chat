...
var chatBottom, chatConnect, chatPanel, chattingList, liveList, messageRouter;
...
$(function() {
  ...
  if (chatConnect) {
    return chatConnect.socket.on('message', function(message) {
      var socket;
      socket = chatConnect.socket;
      return messageRouter(message, socket);
    });
  }
});
