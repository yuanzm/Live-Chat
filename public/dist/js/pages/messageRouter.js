...
var ChatConnect, chatBottom, chatConnect, chatHost, currentId, logStatus, mockData, tpl;
...
},{"./chatBottom.coffee":2,"./chatHost.coffee":4,"./mockData.coffee":10,"./tpl.coffee":11}],4:[function(require,module,exports){
var chatHost;
...
chatPanel = {
  keyDownSendMessage: function(event) {
    if (event.keyCode === 13) {
      return $("#chat-submit").click();
    }
  },
  scrollBottom: function() {
    var chatBox, scrollTop;
    chatBox = $('.chat-log');
   ...
   */
  loadMessageToBox: function(type, msg, name, avatar) {
    var message;
...
},{"./chatConnect.coffee":3,"./chatPerson.coffee":6,"./tpl.coffee":11}],6:[function(require,module,exports){
...
},{"./chatBottom.coffee":2,"./chatConnect.coffee":3,"./chatPerson.coffee":6,"./mockData.coffee":10,"./tpl.coffee":11}],8:[function(require,module,exports){
...
liveList = {
  getIndexInTheChatList: function(id) {
    var flag;
    flag = false;
    $('.live-contact').each(function(index, item) {
      var userIndex;
      id = id;
      userIndex = $(item).find('.user-name').data('userid');
      if (userIndex === id) {
  ...
  addUserToLiveList: function(userid, name) {
    var oneUser, str;
    oneUser = {
      userid: userid,
      name: name
    ...
    return $allLiveUser.append(str);
  },
  removeOneUser: function(id) {
    var index;
  ...
  liveUserClickHandler: function() {
    ...
    if (id !== currentId) {
      if (index === false) {
        ...
        return $('.chat-contact').eq($('.chat-contact').length - 1).click();
      }
    }
  }
};
...
},{"./chatBottom.coffee":2,"./chatConnect.coffee":3,"./chatPerson.coffee":6,"./chattingList.coffee":7,"./tpl.coffee":11}],9:[function(require,module,exports){
var $chatBottomBar, $currentPage, chatBottom, chatPanel, chattingList, currentId, groupChatId, liveList, messageRouter, mockData, person, toAvatar, toUsername, tpl;
...
messageRouter = function(data, socket) {
  var contact, contacts, currentIndex, flag, i, index, isInLiveChat, liveUserArray, messages, newIndex, sender, status, total_new_msg_count, user, _i, _j, _k, _len, _len1, _ref;
  ...
  if (data.dowhat === 'chat') {
    ...
    chatPanel.scrollBottom();
  }
  if (data.dowhat === 'logout') {
    console.log('user_id: ' + data.who + ': ' + data.dowhat);
    flag = chattingList.getIndexInTheChatList(data.who);
    if (flag !== false) {
  ...
  if (data.dowhat === 'get_live_list') {
    ...
    for (_i = 0, _len = liveUserArray.length; _i < _len; _i++) {
      user = liveUserArray[_i];
      liveList.addUserToLiveList(user.id, user.name);
    }
  }
  if (data.dowhat === 'get_chat_list') {
    console.log(data);
    ...
    if (contacts.length) {
      for (_j = 0, _len1 = contacts.length; _j < _len1; _j++) {
        ...
        for (i = _k = 0, _ref = parseInt(contact.new_msg_count); 0 <= _ref ? _k < _ref : _k > _ref; i = 0 <= _ref ? ++_k : --_k) {
...
},{"./chatBottom.coffee":2,"./chatPanel.coffee":5,"./chatPerson.coffee":6,"./chattingList.coffee":7,"./liveList.coffee":8,"./mockData.coffee":10,"./tpl.coffee":11}],10:[function(require,module,exports){
var chatList, msgs;
...
},{"./tpl/one-chatter.tpl":12,"./tpl/one-live-user.tpl":13,"./tpl/one-message.tpl":14,"lodash":1}],12:[function(require,module,exports){
